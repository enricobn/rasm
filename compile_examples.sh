...
time RUST_LOG=info RUST_BACKTRACE=full cargo run --release build -f rasm/resources/examples/gameoflife -o gameoflife
time RUST_LOG=info RUST_BACKTRACE=full cargo run --release build -f rasm/resources/examples/gameoflife_sdl -o gameoflife_sdl
time RUST_LOG=info RUST_BACKTRACE=full cargo run --release build -f rasm/resources/examples/gameoflife_vec -o gameoflife_vec
